...
const first = [9, 5, 7];
const second = [8, 4, 11];
const imageStyles1 = ['imgS1 img img-responsive', 'img img-responsive img-circle imgS2', 'imgS1 img img-responsive'];
const imageStyles2 = ['imgS2 img img-responsive img-circle', 'img img-responsive imgS1', 'imgS2 img img-responsive img-circle'];
			...
			<div className='backgBorder'><div className='backg'></div></div>
					...
					<div className='row' style={{backgroundColor: 'white', margin: '0px'}}>
						<div className="container" style={{paddingTop: '50px'}}>
							...
							<div>
								<ImageTray titles={ftitle} photos={first} styling={imageStyles1} />
								<ImageTray titles={stitle} photos={second} styling={imageStyles2} />
							</div>
							<button className="btn btn-default buttonshop" style={{marginTop: '100px'}}> View Shop </button><br/><br/>
							<p style={{marginBottom: '0px'}}>Or</p><br/>
							<button className="btn btn-default buttonrequest"> Request Custom Order </button>
						</div>
					</div>
					<LinksExit />
			</div>
